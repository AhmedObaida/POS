...
@section('title', __('admin.products.edit'))

@section('content')
<h1 class="h3 mb-3">{{ __('admin.products.edit') }}</h1>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                        <option value="active" {{ old('status', $product->status) === 'active' ? 'selected' : '' }}>{{ __('admin.products.status_active') }}</option>
                        <option value="inactive" {{ old('status', $product->status) === 'inactive' ? 'selected' : '' }}>{{ __('admin.products.status_inactive') }}</option>
                    </select>
